...
import com.appcore.core.thread.AppServerShutdownHook;
  ...
  implements IAppServer
{
  ...
  {
    LOGGER.info("开始初始化spring...【{}】", new Object[] { confPath + "spring/spring-main.xml" });

    ApplicationContext context = new FileSystemXmlApplicationContext("classpath:spring/spring-main.xml");
